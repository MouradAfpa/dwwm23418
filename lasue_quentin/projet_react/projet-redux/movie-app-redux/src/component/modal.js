    ...
    return ( 
        <Modal show={show} onHide={handleClose} size="lg" aria-labelledby="contained-modal-title-vcenter" centered>
            <Modal.Header className='bg-info text-light border-black' closeButton closeVariant='white'>
                <Modal.Title >{props.movie.title?props.movie.title:props.movie.name}</Modal.Title>
            </Modal.Header>
                ...
                <Container>
                    <Row>
                        ...
                        <Col>
                            ...
                            <p> Date de sortie : {props.movie.release_date?props.movie.release_date:props.movie.first_air_date}</p>
